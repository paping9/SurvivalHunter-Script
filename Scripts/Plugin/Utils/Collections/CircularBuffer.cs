...
{
    //
    // ref: https://github.com/joaoportela/CircularBuffer-CSharp/blob/master/CircularBuffer/CircularBuffer.cs
    //
    ...
    public class CircularBuffer<T> : IEnumerable<T>
    {
        ...
        public T[] ToArray(int count)
        {
            ...
            foreach (ArraySegment<T> segment in segments)
            {
                int copyCount = (segment.Count < remainCount) ? segment.Count : remainCount;
                Array.Copy(segment.Array, segment.Offset, newArray, newArrayOffset, copyCount);

                remainCount -= copyCount;
                newArrayOffset += copyCount;
            }
            return newArray;
        }
