...
public class PacketManager
{
    ...
    public void Register()
    {
        ...
        _makeFunc.Add((ushort)PacketID.S_BroadcastLeavGame, MakePacket<S_BroadcastLeavGame>);
        _handler.Add((ushort)PacketID.S_BroadcastLeavGame, PacketHandler.S_BroadcastLeavGameHandler);
